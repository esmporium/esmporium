...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["dataset_version_id"],
            ["datasetversion.id"],
            name=op.f("fk_datasetversionnodelink_dataset_version_id_datasetversion"),
        ),
        sa.ForeignKeyConstraint(
            ["node_id"],
    ...
    with op.batch_alter_table("datasetversionnodelink", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_datasetversionnodelink_node_id"), ["node_id"], unique=False
        )
...
def downgrade() -> None:
    ...
    with op.batch_alter_table("datasetversionnodelink", schema=None) as batch_op:
        batch_op.drop_index(batch_op.f("ix_datasetversionnodelink_node_id"))
        batch_op.drop_index(batch_op.f("ix_datasetversionnodelink_dataset_version_id"))
    ...
    with op.batch_alter_table("datasetnodeinformation", schema=None) as batch_op:
        batch_op.drop_index(batch_op.f("ix_datasetnodeinformation_data_node"))
